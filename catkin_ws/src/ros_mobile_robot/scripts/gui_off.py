...
from limit import initialize, start_limit, stop_limit
...
class NavGUI(QWidget):
    ...
    def initUI(self):
        ...
        self.max_vel_x_label = QLabel('Max Velocity (m/s):')
        self.max_vel_x_input = QLineEdit()
        self.min_vel_x_label = QLabel('Min Velocity (m/s):')
        ...
        group_6 = QGroupBox('Limit ws:')
        layout_6 = QVBoxLayout()
#        self.rectangle_label = QLabel('rectangle')
#        self.rectangle_input = QLineEdit()
        self.circle_label = QLabel('Circle radius')
        self.circle_input = QLineEdit()
        self.set_limit_button = QPushButton('Set Limit')
        self.set_limit_button.clicked.connect(self.set_limit)
        self.cancel_button = QPushButton('Cancel Limit')
        self.cancel_button.clicked.connect(self.cancel)        
#        layout_6.addWidget(self.rectangle_label)
#        layout_6.addWidget(self.rectangle_input)
        layout_6.addWidget(self.circle_label)
        layout_6.addWidget(self.circle_input)
        layout_6.addWidget(self.set_limit_button)
        layout_6.addWidget(self.cancel_button)
        group_6.setLayout(layout_6)
...
#        layout.addWidget(group_5, 2, 0, 1, 2) # Thêm nhóm cài đặt vận tốc vào cột 0, dòng 2, rộng 1, cao 2
        layout.addWidget(group_5, 2, 0)
        layout.addWidget(group_6, 2, 1)
    ...
    def set_limit(self):
        initialize()
        radius = float(self.circle_input.text()) 
        start_limit(radius)
