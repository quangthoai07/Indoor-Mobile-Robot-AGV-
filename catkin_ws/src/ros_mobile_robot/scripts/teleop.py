    ...
    def run_circle(self):
        ...
        while not rospy.is_shutdown():
            ...
            if time_duration>timeOneCircle:
               rospy.signal_shutdown('[ROS] Done node_nav_Circle')
    ...
    def run_square(self):
        ...
        while not rospy.is_shutdown():
            ...
            if time_duration < 6:
                ...
                v = 0.3 #0.5
                w = 0.0
            if time_duration >= 6 and time_duration < 7.779:
                pass
                v = 0.0
                w = -0.785
            if time_duration >= 7.779 and time_duration < 13.779:
                pass
                v = 0.3
                w = 0.0
            if time_duration >= 13.779 and time_duration < 15.558:
                pass
                v = 0.0
                w = -0.785
            if time_duration >= 15.558 and time_duration < 21.558:
                pass
                v = 0.3
                w = 0.0
            if time_duration >= 21.558 and time_duration < 23.337:
                pass
                v = 0.0
                w = -0.785
            if time_duration >= 23.337 and time_duration < 29.337:
                pass
                v = 0.3
                w = 0.0
           
            if time_duration >=29.337:
                v = w = 0
            #set v, w
